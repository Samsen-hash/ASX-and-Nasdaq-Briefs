...
def build_sparkline(series: list[float], width: int = 110, height: int = 28) -> str:
...
<style>
  ...
  * {{ box-sizing: border-box; }}
  ...
  .wl-tbl th {{ text-align: left; font-size: 10px; text-transform: uppercase; color: var(--muted); letter-spacing: 0.5px; padding: 8px 10px; border-bottom: 1px solid var(--border); }}
  .wl-tbl td {{ padding: 10px 10px; border-bottom: 1px solid var(--border); vertical-align: middle; }}
  .wl-tbl th.wl-ticker, .wl-tbl td.wl-ticker {{ width: 70px; }}
  .wl-tbl th.wl-last, .wl-tbl td.wl-last {{ width: 75px; text-align: right; font-variant-numeric: tabular-nums; }}
  .wl-tbl th.wl-pct, .wl-tbl td.wl-pct {{ width: 75px; text-align: right; font-weight: 600; font-variant-numeric: tabular-nums; }}
  .wl-tbl th.wl-trend, .wl-tbl td.wl-trend {{ width: 130px; }}
  .wl-tbl th.wl-thesis, .wl-tbl td.wl-thesis {{ padding-left: 18px; }}
  .thesis-list {{ margin: 0; padding: 0 0 0 16px; font-size: 11.5px; color: var(--muted); line-height: 1.45; }}
  .thesis-list li {{ margin: 1px 0; }}
