...
<div class="container">
  ...
  <div id="tab-ndx" class="tab-content">
    ...
    <h2>Watchlist + News Flow</h2>
    {'<div class="wl-grid"><div class="card wl-main">' + build_watchlist_table(data["ndx_watchlist"]) + '</div><div class="card wl-side"><div class="wl-side-title">📰 Overnight News Hits</div>' + build_news_hits_table(data["ndx_news_hits"]) + '</div></div>' if any(h["count"] > 0 for h in data["ndx_news_hits"]) else '<div class="card">' + build_watchlist_table(data["ndx_watchlist"]) + '</div>'}
    <div class="grid3">
