...
<div class="container">
  ...
  <div id="tab-asx" class="tab-content active">
    ...
    <div class="wl-grid">
      <div class="card wl-main">{build_watchlist_table(data["asx_watchlist"])}</div>
      <div class="card wl-side">
        <div class="wl-side-title">📰 Overnight News Hits</div>
        {build_news_hits_table(data["asx_news_hits"])}
      </div>
    </div>
    <div class="grid3">
  ...
  <div id="tab-ndx" class="tab-content">
    ...
    <h2>Watchlist + News Flow</h2>
    <div class="wl-grid">
      <div class="card wl-main">{build_watchlist_table(data["ndx_watchlist"])}</div>
      <div class="card wl-side">
        <div class="wl-side-title">📰 Overnight News Hits</div>
        {build_news_hits_table(data["ndx_news_hits"])}
      </div>
    </div>
    <div class="grid3">
